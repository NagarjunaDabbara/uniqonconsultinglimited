        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 top-left">
              <span className="phone wow fadeInDown" data-wow-duration=".8s" data-wow-delay=".3s">
                <i className="glyphicon glyphicon-phone" />
               <em> +44 (0)2039 230700</em>
              </span>
              <span className="email wow fadeInDown" data-wow-duration=".8s" data-wow-delay=".3s">
                <i className="glyphicon glyphicon-send" />
                <em><a href="">info@uniqon.co.uk</a></em>
              </span>
         ...
         <hr className="hr"/>
              ...
              <div className="container">
                <div className="col-md-8 col-sm-8 col-xs-8 top-left">
                  <p><i className="fa fa-map-marker" aria-hidden="true" />Central Milton Keynes,United Kingdom. </p>
                </div>
                <div className="col-md-4 col-sm-4 col-xs-4 top-right">
                  <a href="https://uniqon.peoplehr.net/" target="_blank" className="login"><span /><strong>Employee Login</strong></a>
                  <a  href="https://uniqon.peoplehr.net/" target="_blank" className="login"><span /> <strong>HRMS Login</strong></a>
                </div>> 
